...
const styles = StyleSheet.create({
  ...
  competencia: { fontWeight: '700', fontSize: 15, color: '#f1f5f9' },
  badge: { paddingVertical: 4, paddingHorizontal: 10, borderRadius: 12 },
  badgeText: { color: '#fff', fontSize: 11, fontWeight: '600' },
  nome: { fontSize: 12, color: '#94a3b8', marginTop: 4 },
  ...
  modalTitle: { fontWeight: '700', fontSize: 15, marginBottom: 10, color: '#f1f5f9' },
  modalHint: { fontSize: 12, color: '#94a3b8', marginBottom: 12, lineHeight: 17 },
  modalInput: { borderWidth: 1, borderColor: '#1e3a5f', borderRadius: 8, padding: 10, minHeight: 80, textAlignVertical: 'top', backgroundColor: '#162032', color: '#f1f5f9' },
  modalActions: { flexDirection: 'row', justifyContent: 'flex-end', gap: 20, marginTop: 14 },
  modalCancel: { color: '#94a3b8', fontWeight: '600' },
  ...
  btnLimparText: { color: '#64748b', fontSize: 12, fontWeight: '600' },
});
