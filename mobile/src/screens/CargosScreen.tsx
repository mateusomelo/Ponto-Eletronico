...
const styles = StyleSheet.create({
  ...
  nome: { fontWeight: '700', fontSize: 15, color: '#f1f5f9' },
  totalUsuarios: { fontSize: 11, color: '#94a3b8' },
  descricao: { fontSize: 12, color: '#94a3b8', marginTop: 4 },
  permsWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 10 },
  permChip: { backgroundColor: 'rgba(99,102,241,.2)', borderRadius: 6, paddingVertical: 4, paddingHorizontal: 8 },
  permChipText: { fontSize: 10, color: '#a5b4fc' },
});
