...
const styles = StyleSheet.create({
  ...
  nome: { fontSize: 17, fontWeight: '700', color: '#f1f5f9', textAlign: 'center', marginTop: 10 },
  email: { fontSize: 13, color: '#94a3b8', textAlign: 'center' },
  cargo: { fontSize: 12, color: '#64748b', textAlign: 'center', marginBottom: 20 },
  sectionTitle: { fontSize: 14, fontWeight: '700', color: '#f1f5f9', marginBottom: 8 },
  bioRow: { flexDirection: 'row', alignItems: 'center' },
  bioLabel: { fontSize: 14, fontWeight: '600', color: '#f1f5f9' },
  bioDesc: { fontSize: 11, color: '#64748b', marginTop: 2 },
  bioDescErro: { fontSize: 11, color: '#ef4444', marginTop: 2 },
  card: { backgroundColor: '#1e293b', borderRadius: 12, padding: 16 },
  label: { fontSize: 12, color: '#94a3b8', marginBottom: 4, marginTop: 10 },
  input: { borderWidth: 1, borderColor: '#1e3a5f', borderRadius: 8, paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, color: '#f1f5f9', backgroundColor: '#162032' },
