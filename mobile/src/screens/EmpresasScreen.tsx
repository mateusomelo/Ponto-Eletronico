...
const styles = StyleSheet.create({
  ...
  statCard: { width: '31%', backgroundColor: '#1e293b', borderRadius: 10, padding: 10, alignItems: 'center' },
  statValue: { fontSize: 16, fontWeight: '800', color: '#f1f5f9', marginTop: 4 },
  ...
  empNome: { fontSize: 14, fontWeight: '700', color: '#f1f5f9', flex: 1 },
  badge: { paddingHorizontal: 8, paddingVertical: 3, borderRadius: 10 },
  badgeText: { fontSize: 10, fontWeight: '700' },
  empMeta: { fontSize: 11, color: '#64748b', marginTop: 2, marginBottom: 10 },
